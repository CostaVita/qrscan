package com.qrscanner.qrcode.barcode.reader.scanner.ui.scan;
...
import com.qrscanner.qrcode.barcode.reader.scanner.helpers.util.FileUtils;
...
import com.qrscanner.qrcode.barcode.reader.scanner.helpers.util.image.ImageInformation;
import com.qrscanner.qrcode.barcode.reader.scanner.helpers.util.image.ImagePicker;
import com.qrscanner.qrcode.barcode.reader.scanner.ui.pickedfromgallery.PickedQRFromGalleryActivity;
...
public class ScanningFragment extends androidx.fragment.app.Fragment implements View.OnClickListener {
            ...
            public void barcodeResult(BarcodeResult result) {
                ...
                if (result != null
                    ...
                    if (result.getBitmap() != null) {
                        ...
                        File codeImageFile = FileUtils.getEmptyFile(mContext, AppConstants.PREFIX_IMAGE,
                    ...
                    Intent intent = new Intent(mContext, ScannigResultActivity.class);
    ...
    private void doPreRequisites() {
        ...
        mBeepManager.setVibrateEnabled(SharedPrefUtils.readBooleanDefaultTrue(PreferenceKey.VIBRATE));
        mBeepManager.setBeepEnabled(SharedPrefUtils.readBooleanDefaultTrue(PreferenceKey.PLAY_SOUND));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ImagePicker.REQUEST_CODE_PICK_IMAGE && mContext != null) {
            ...
            if (result != null) {
                ImageInformation imageInfo = ImagePicker.getPickedImageInfo(mContext, resultCode, data);
                ...
                if (imageInfo != null
                    ...
                    if (!TextUtils.isEmpty(imagePath)) {
                        ...
                        Intent intent = new Intent(mContext, PickedQRFromGalleryActivity.class);
                        intent.putExtra(IntentKey.MODEL, code);
                        startActivity(intent);
                    } else {
