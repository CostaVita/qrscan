...
import com.qrscanner.qrcode.barcode.reader.scanner.MyQRCobaApplication;
...
public class PermissionUtils {
    ...
    public static PermissionUtils on() {
        if (sInstance == null) {
    ...
    boolean isAllowed(String permission) {
        ...
        return MyQRCobaApplication.getContext().checkSelfPermission(permission)
