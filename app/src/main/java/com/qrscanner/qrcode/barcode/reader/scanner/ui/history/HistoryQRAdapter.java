...
import com.qrscanner.qrcode.barcode.reader.scanner.helpers.itemtouch.ItemTouchHelperAdapter;
...
import qrcode.qrscanner.barcode.scanner.databinding.ItemHistoryBinding;

import com.qrscanner.qrcode.barcode.reader.scanner.ui.base.ItemClickListener;

public class HistoryQRAdapter extends RecyclerView.Adapter<HistoryQRAdapter.HistoryQRViewHolder> implements ItemTouchHelperAdapter {
    /**
     * Fields
     */
    ...
    public HistoryQRAdapter(ItemClickListener<Code> itemClickListener) {
    ...
    @NonNull
    @Override
    public HistoryQRViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new HistoryQRViewHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),
                R.layout.item_history, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull HistoryQRViewHolder holder, int position) {
    ...
    class HistoryQRViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        private ItemHistoryBinding mBinding;

        HistoryQRViewHolder(@NonNull ItemHistoryBinding itemBinding) {
        ...
        void bind(Code item) {
            ...
            if (context != null) {
                ...
                mBinding.textViewTime.setText(
                        TimeUtils.getFormattedDateString(item.getTimeStamp(),
