...
public class ImagePicker {
     ...
     */
    public static ImageInformation getPickedImageInfo(Context context, int resultCode, Intent intentWithImage) {
        if (context == null || resultCode != Activity.RESULT_OK) {
            return null;
        }

        return new ImageInformation(intentWithImage.getData(), false);
    }
    ...
    public static Bitmap getPickedImageFromResult(Context context, int resultCode, Intent intentWithImage) {
        ...
        ImageInformation pickedImageInfo = getPickedImageInfo(context, resultCode, intentWithImage);
    ...
    private static int getRotation(Context context, Uri imageUri) {
        ...
        Log.d("Image rotate", String.valueOf(rotation));
        return rotation;
    }
